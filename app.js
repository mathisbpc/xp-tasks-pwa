/* =========================================================
   XP Tasks PWA - app.js
   Version: adaptée à ton Google Sheet (habitudes + XP + niveaux)
   ========================================================= */

/**
 * ✅ MODIF FACILE ICI : Tes tâches + valeurs XP + icône (emoji)
 * id doit être unique
 * xp peut être positif (gain) ou négatif (perte)
 */
const DEFAULT_TASKS = [
...
/**
 * ✅ Niveaux : basé sur ton titre (9 niveaux).
 * Comme tu débutes, on fait simple :
 * - on utilise des seuils XP (minXp)
 * - on réutilise tes 4 images existantes
 *
 * Exemple: Total XP 30 => niveau 2 ("Larve disciplinée") ✅
 */
const LEVELS = [
  { key: "lvl1", label: "État de larve 🐛",              minXp: 0,   image: "assets/larve.png" },
  { key: "lvl2", label: "Larve disciplinée 🐜",          minXp: 20,  image: "assets/larve.png" },
  { key: "lvl3", label: "Pitit Soldat ⚔️",               minXp: 40,  image: "assets/apprenti.png" },
  { key: "lvl4", label: "Soldat 🪖",                     minXp: 60,  image: "assets/apprenti.png" },
  { key: "lvl5", label: "Pirate des océans﹏𓊝﹏",        minXp: 80,  image: "assets/apprenti.png" },
  { key: "lvl6", label: "Apothicaire",                   minXp: 100, image: "assets/mage.png" },
  { key: "lvl7", label: "Guerrier Démoniaque 👹",        minXp: 120, image: "assets/mage.png" },
  { key: "lvl8", label: "Maître Samuraï ⛩️🥷",           minXp: 140, image: "assets/archimage.png" },
  { key: "lvl9", label: "Niveau Dieu 👹⚔☯⛩️🏯",          minXp: 160, image: "assets/archimage.png" },
];
...
function loadTodayState() {
  ...
  // Si la date a changé => reset automatique
